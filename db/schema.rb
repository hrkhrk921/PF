...
ActiveRecord::Schema.define(version: 20_200_702_070_906) do
  ...
  create_table 'blogs', force: :cascade do |t|
    ...
    t.text 'body', limit: 4_294_967_295, null: false
  ...
  create_table 'counsel_comments', force: :cascade do |t|
    ...
    t.index ['parent_id'], name: 'index_counsel_comments_on_parent_id'
